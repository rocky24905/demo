...
import './Manualfinalmeritlist.css'

const Manualfinalmeritlist = ()=>{
    return(
        <div className="scroll">
             <div className="con">
            <div className="left1"><i class="fa-solid fa-house-chimney"></i><a href="#">Home</a>/ Manual Final Merit List</div>
             ...
             <div className="Manual">
                <from>
                <label htmlFor="role" className="Manuall">Choose shift *</label>
                <select id="role" name="role" className="Manualbox">
                ...
                <label htmlFor="role" className="Manuall">Choose class *</label>
                <select id="role" name="role" className="Manualbox">
                ...
                <label htmlFor="role" className="Manuall">Choose group *</label>
                <select id="role" name="role" className="Manualbox">
                    ...
                    <label htmlFor="role" className="Manuall">Choose section *</label>
                    <select id="role" name="role" className="Manualbox">
                      <option value="one">Choose one</option>
                    </select>

                    <div className="final" ><a href="#">Show student list for mark and position setup</a></div>
...
export default Manualfinalmeritlist;