...
const Assingteachershift = () =>{
  return(
    <div className="scroll">
        <div className="con">
            <div className="left1"><i class="fa-solid fa-house-chimney"></i><a href="#">Home</a>/ Assing Teacher Shift</div>
...
export default Assingteachershift;